...
export const UPGRADES: UpgradeDef[] = [
    ...
    effects: [
      {
        ...
        name: 'Wood Amount +1',
        source: 'upgrade',
        modifiers: [{ stat: 'prod.wood.amount', type: 'add', value: 1 }],
      },
    ],
  },
  {
    ...
    effects: [
      {
        ...
        name: 'Wood Speed x2',
        source: 'upgrade',
        modifiers: [{ stat: 'prod.wood.speed', type: 'mul', value: 2 }],
      },
    ],
  },
  {
  ...
  {
    id: 'auto.tree.oak',
    name: 'Auto Cutter: Oak',
    description: 'Unlock auto-cut for Oak Tree',
    cost: { gold: 150, wood: 50 },
    unlocks: { autoNodeId: 'tree.oak' },
  },
];
